<template>
  <div class="nav-bar">
    <v-app-bar class="pt-3" color="#02218f" elevation="0">
      <v-app-bar-nav-icon></v-app-bar-nav-icon>
      <v-container class="py-0" fluid height="200">
        <v-row class="mt-4">
          <v-col cols="3">
            <img
          ...
          <v-col cols="5">
            <div class="position-relative">
              <input
                ...
                name="navSearch"
                id="navSearch"
                style="width: 90%; border-radius: 30px; outline: none"
                placeholder="Search the store"
                class="py-2 px-5 bg-white mt-13"
              />
              <svg
                style="position: absolute; right: 65px; top: 30%"
                fill="black"
                data-icon="search"
                viewBox="0 0 512 512"
                width="25px"
          ...
          <v-col cols="4">
            <div class="parent d-flex justify-space-between align-center mt-13">
              <div class="available">
                <span>Availabl 24/7 at</span>
                <br />
    ...
    <v-app-bar color="#02218f" :elevation="2">
      <v-container fluid>
        <v-row>
          <v-col cols="8">
            <ul
