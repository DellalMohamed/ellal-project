<template>
  <div class="quality-features py-13 bg-grey-lighten-2">
    <v-container fluid>
      <v-row>
        <v-col class="px-2" v-for="card in cards" :key="card.title">
    ...
    cards: [
      {
        ...
        desc: "jComperhensive quality control and afforable prices",
      ...
      {
        title: "fast shipping",
        desc: "fast and convenient door to door delivey",
      ...
      },
      {
        ...
        desc: "More than IO different secure payment methods",
      ...
      {
        title: "have question?",
        desc: "24/7 Customer service - we're here and hapy to help",
